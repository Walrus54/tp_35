...
//  онструктор: фиксируем размер холста, создаЄм фигуры, обнул€ем угол поворота.
Area::Area(QWidget *parent) : QWidget(parent)
{
    setFixedSize(QSize(300, 200));
    myline = new MyLine(80, 100, 50);  // лини€ в левой части холста
...
// ƒеструктор: освобождаем динамически созданные фигуры.
Area::~Area()
{
    delete myline;
    delete myrect;
